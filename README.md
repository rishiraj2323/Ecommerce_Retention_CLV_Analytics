...
!\[Business Overview](screenshots/page1\_business\_overview.png)
...
!\[Retention Deep-Dive](screenshots/page2\_retention\_deepdive.png)
...
Ecommerce\_Retention\_Project/

├── data/raw/ # Raw Olist CSVs (excluded from repo — see Kaggle link above)

├── notebooks/

│ └── 01\_data\_extraction\_eda.ipynb # Data loading, EDA, RFM analysis

├── sql/

│ └── schema\_and\_queries.sql # Database schema and queries

├── powerbi/

│ └── ecommerce\_retention\_dashboard.pbix
...
\- SP (São Paulo) is the highest-revenue state by a wide margin
